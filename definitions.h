// Neopixel
#define PIN 5         // PIN where neopixel / WS2811 strip is attached WERKT NIET OP PIN 6!!
#define NUMLEDS 300    // Number of leds in the strip

const char HOSTNAME[] = "5meterledstrip";   // Friedly hostname
...
enum MODE { SET_MODE, HOLD, OFF, ALL, WIPE, RAINBOW, RAINBOWCYCLE, THEATERCHASE, THEATERCHASERAINBOW, TV, CUSTOM, MERRY_CHRISTMAS, TWINKLE_FADE };
